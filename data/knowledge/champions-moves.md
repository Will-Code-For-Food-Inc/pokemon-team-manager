Extracted 494 moves
# Pokémon Champions — Available Moves

Source: serebii.net/pokemonchampions/moves.shtml

In Pokémon Champions, each Pokémon has a curated pool of moves to choose from. Only moves listed here exist in the game.
...
| Baton Pass | Normal | Status | 20 | — | — | The user switches out of battle to be replaced by another party Pok&eacute;mon. If the user had any stat changes a substitute or other such effects they will be passed on to the Pok&eacute;mon switching in. |
...
| Beat Up | Dark | Physical | 12 | — | 100 | The target is attacked as many times as the number of Pok&eacute;mon in the user's party. Pok&eacute;mon that have fainted or have a status condition are not counted. This move's power is calculated based on the Attack stats of the party Pok&eacute;mon. |
...
| Chilly Reception | Ice | Status | 12 | — | — | Summons snow for 5 turns. The user switches out of battle to be replaced by another party Pok&eacute;mon. |
| Circle Throw | Fighting | Physical | 12 | 60 | 90 | If there are other Pok&eacute;mon in the target's party that can switch into battle the target is forced to switch out of battle and is replaced by one of those Pok&eacute;mon at random. |
...
| Corrosive Gas | Poison | Status | 20 | — | 100 | Causes all other Pok&eacute;mon on the field to lose their held items. |
...
| Curse | Ghost | Status | 12 | — | — | Ghost-type: The user loses 1/2 of its max HP to give the target the Cursed status.<br />Non-Ghost-type: Lowers the user's Speed stat by 1 stage and boosts its Attack and Defense stats by 1 stage. |
...
| Dragon Darts | Dragon | Physical | 12 | 50 | 100 | The user attacks twice in a row. If there are 2 opposing Pok&eacute;mon each of them is attacked once. |
| Dragon Pulse | Dragon | Special | 12 | 85 | 100 |  |
| Dragon Rush | Dragon | Physical | 12 | 100 | 75 | Has a 20% chance of making the target flinch. If the target has the Minimized status this move's power is doubled and it will be sure to hit. |
| Dragon Tail | Dragon | Physical | 12 | 60 | 90 | If there are other Pok&eacute;mon in the target's party that can switch into battle the target is forced to switch out of battle and is replaced by one of those Pok&eacute;mon at random. |
...
| Fairy Lock | Fairy | Status | 12 | — | — | Gives all Pok&eacute;mon on the field the Fairy Locked status. |
...
| Flip Turn | Water | Physical | 20 | 60 | 100 | After attacking the user switches out of battle to be replaced by another party Pok&eacute;mon. |
...
| Freeze-Dry | Ice | Special | 20 | 70 | 100 | This move is also super effective against Water-type Pok&eacute;mon. |
...
| Heal Bell | Normal | Status | 8 | — | — | The user cures the status conditions of all the Pok&eacute;mon in its party including itself as well as its allies. |
| Heal Pulse | Psychic | Status | 12 | — | — | Restores 1/2 of the target's max HP. |
| Healing Wish | Psychic | Status | 12 | — | — | The user faints. The Pok&eacute;mon taking its place will have its HP fully restored and its status conditions cured. |
...
| Last Respects | Ghost | Physical | 12 | 50 | 100 | This move's power is increased by 50 for each time that a Pok&eacute;mon in the user's party has fainted. |
...
| Metal Burst | Steel | Physical | 12 | — | 100 | The user retaliates to deal 150% of the damage it took from an opponent's move during the turn this move is used. |
...
| Parting Shot | Dark | Status | 20 | — | 100 | Lowers the target's Attack and Sp. Atk stats by 1 stage. The user then switches out of battle to be replaced by another party Pok&eacute;mon. |
| Payback | Dark | Physical | 12 | 50 | 100 | This move's power is doubled if the user attacks after the target. |
| Perish Song | Normal | Status | 8 | — | — | Gives all Pok&eacute;mon on the field the Perishing status. |
...
| Roar | Normal | Status | 20 | — | — | If there are other Pok&eacute;mon in the target's party that can switch into battle the target is forced to switch out of battle and is replaced by one of those Pok&eacute;mon at random. |
...
| Round | Normal | Special | 16 | 60 | 100 | If multiple Pok&eacute;mon use this move in the same turn the second user onward will act immediately after the first and the power of the second Round onward will be doubled. |
...
| Shed Tail | Normal | Status | 12 | — | — | The user loses 1/2 of its max HP to create a substitute then switches out of battle to be replaced by another party Pok&eacute;mon. The substitute will be hit by moves instead of that Pok&eacute;mon and it will vanish when it takes damage equal to 1/4 of the user's max HP. |
| Sheer Cold | Ice | Special | 8 | — | 30 | Knocks out the target. This move does not affect Ice types. The accuracy of this move is fixed at 30%. If used by Pok&eacute;mon other than Ice types the accuracy of this move is 20%. |
...
| Swallow | Normal | Status | 12 | — | — | The higher the user's Stockpiling level the more HP the user restores. Level 1<br /> 1/4 of the user's max HP is restored. Level 2<br /> 1/2 of the user's max HP is restored. Level 3<br /> The user's HP is fully restored. This move fails unless the user has the Stockpiling status.<br /> |
...
| Teatime | Normal | Status | 12 | — | — | Causes all Pok&eacute;mon on the field to eat their held Berries. |
| Teeter Dance | Normal | Status | 20 | — | 100 | Confuses all other Pok&eacute;mon on the field. |
...
| Triple Axel | Ice | Physical | 12 | 20 | 90 | The user attacks 3 times in a row-first with a power of 20 then with a power of 40 then with a power of 60. The attack ends if the user misses. |
...
| U-turn | Bug | Physical | 20 | 70 | 100 | After attacking the user switches out of battle to be replaced by another party Pok&eacute;mon. |
...
| Volt Switch | Electric | Special | 20 | 70 | 100 | After attacking the user switches out of battle to be replaced by another party Pok&eacute;mon. |
...
| Weather Ball | Normal | Special | 12 | 50 | 100 | When a weather condition is present this move's power is doubled and its type changes. Harsh sunlight<br /> Fire type. Rain<br /> Water type. Snow<br /> Ice type. Sandstorm<br /> Rock type.<br /> |
...
| Whirlwind | Normal | Status | 20 | — | — | If there are other Pok&eacute;mon in the target's party that can switch into battle the target is forced to switch out of battle and is replaced by one of those Pok&eacute;mon at random. |
